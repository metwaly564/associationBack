-- إضافة إعدادات الألوان إلى جدول site_settings
-- استخدم: psql -U postgres -d association_db -f admin-cms/database/add_color_settings_to_site_settings.sql

SET client_encoding TO 'UTF8';

-- إدراج إعدادات الألوان الافتراضية
...
SELECT '✅ تم إضافة إعدادات الألوان بنجاح!' AS message;